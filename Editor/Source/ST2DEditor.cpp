...
namespace STEditor
{
	...
	void ST2DEditor::styleDarkUI()
	{
		...
		colors[ImGuiCol_CheckMark] = ImVec4(0.17f, 0.61f, 0.20f, 1.00f);
	...
	void ST2DEditor::styleLightUI()
	{
		...
		colors[ImGuiCol_ChildBg] = ImVec4(1.0f, 1.0f, 1.0f, 0.00f);
		colors[ImGuiCol_PopupBg] = ImVec4(1.0f, 1.0f, 1.0f, 0.92f);
		colors[ImGuiCol_Border] = ImVec4(0.82f, 0.82f, 0.82f, 0.29f);
		colors[ImGuiCol_BorderShadow] = ImVec4(1.0f, 1.0f, 1.0f, 0.24f);
		colors[ImGuiCol_FrameBg] = ImVec4(1.0f, 1.0f, 1.0f, 0.54f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(1.0f, 1.0f, 1.0f, 0.54f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(1.0f, 1.0f, 1.0f, 1.00f);
		colors[ImGuiCol_TitleBg] = ImVec4(1.0f, 1.0f, 1.0f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(1.0f, 1.0f, 1.0f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(1.0f, 1.0f, 1.0f, 1.00f);
		colors[ImGuiCol_MenuBarBg] = ImVec4(1.0f, 1.0f, 1.0f, 1.00f);
		colors[ImGuiCol_ScrollbarBg] = ImVec4(1.0f, 1.0f, 1.0f, 0.54f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.34f, 0.34f, 0.34f, 0.54f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.40f, 0.40f, 0.40f, 0.54f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.56f, 0.56f, 0.56f, 0.54f);
		colors[ImGuiCol_CheckMark] = ImVec4(0.21f, 0.55f, 0.23f, 1.00f);
		colors[ImGuiCol_SliderGrab] = ImVec4(0.34f, 0.34f, 0.34f, 0.54f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.56f, 0.56f, 0.56f, 0.54f);
		colors[ImGuiCol_Button] = ImVec4(0.9f, 0.9f, 0.9f, 0.8f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.98f, 0.98f, 0.98f, 0.8f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.94f, 0.94f, 0.94f, 1.00f);
		colors[ImGuiCol_Header] = ImVec4(1.0f, 1.0f, 1.0f, 0.52f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.00f, 0.00f, 0.00f, 0.36f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.20f, 0.22f, 0.23f, 0.33f);
		colors[ImGuiCol_Separator] = ImVec4(0.0f, 0.0f, 0.0f, 0.29f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.44f, 0.44f, 0.44f, 0.29f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.40f, 0.44f, 0.47f, 1.00f);
		colors[ImGuiCol_ResizeGrip] = ImVec4(1.0f, 1.0f, 1.0f, 0.29f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.44f, 0.44f, 0.44f, 0.29f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(0.40f, 0.44f, 0.47f, 1.00f);
		colors[ImGuiCol_Tab] = ImVec4(1.0f, 1.0f, 1.0f, 0.52f);
		colors[ImGuiCol_TabHovered] = ImVec4(1.0f, 1.0f, 1.0f, 1.00f);
		colors[ImGuiCol_TabActive] = ImVec4(1.0f, 1.0f, 1.0f, 0.36f);
		colors[ImGuiCol_TabUnfocused] = ImVec4(0.00f, 0.00f, 0.00f, 0.52f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.14f, 0.14f, 0.14f, 1.00f);
		colors[ImGuiCol_PlotLines] = ImVec4(1.00f, 0.00f, 0.00f, 1.00f);
		colors[ImGuiCol_PlotLinesHovered] = ImVec4(1.00f, 0.00f, 0.00f, 1.00f);
		colors[ImGuiCol_PlotHistogram] = ImVec4(1.00f, 0.00f, 0.00f, 1.00f);
		colors[ImGuiCol_PlotHistogramHovered] = ImVec4(1.00f, 0.00f, 0.00f, 1.00f);
		colors[ImGuiCol_TableHeaderBg] = ImVec4(1.0f, 1.0f, 1.0f, 0.52f);
		colors[ImGuiCol_TableBorderStrong] = ImVec4(1.0f, 1.0f, 1.0f, 0.52f);
		colors[ImGuiCol_TableBorderLight] = ImVec4(1.0f, 1.0f, 1.0f, 0.29f);
		colors[ImGuiCol_TableRowBg] = ImVec4(1.0f, 1.0f, 1.0f, 0.00f);
		colors[ImGuiCol_TableRowBgAlt] = ImVec4(1.0f, 1.00f, 1.00f, 1.00f);
		colors[ImGuiCol_TextSelectedBg] = ImVec4(1.0f, 1.0f, 1.0f, 1.00f);
		colors[ImGuiCol_DragDropTarget] = ImVec4(0.33f, 0.67f, 0.86f, 1.00f);
		colors[ImGuiCol_NavHighlight] = ImVec4(1.00f, 0.00f, 0.00f, 1.00f);
		colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.00f, 0.00f, 0.00f, 0.70f);
		colors[ImGuiCol_NavWindowingDimBg] = ImVec4(1.00f, 1.0f, 1.0f, 1.00f);
		colors[ImGuiCol_ModalWindowDimBg] = ImVec4(1.00f, 1.0f, 1.0f, 0.35f);
	...
	{
		m_referenceLayer.onKeyButton(window, *m_renderer2D, key, scancode, action, mods);
	...
	{
		m_referenceLayer.onMouseButton(window, *m_renderer2D, button, action, mods);
	...
	{
		m_referenceLayer.onMouseMoved(window, *m_renderer2D, xpos, ypos);
	...
	void ST2DEditor::onRenderUI()
	{
		...
		ImGui::Checkbox("Night Mode", &m_currentNightMode);
	...
	{
		m_referenceLayer.onUpdate(deltaTime);
