...
namespace STEditor
{
	...
	{
		// dark style from https://github.com/ocornut/imgui/issues/707#issuecomment-917151020
	...
	void ST2DEditor::styleLightUI()
	{
		...
		colors[ImGuiCol_WindowBg] = ImVec4(1.00f, 1.00f, 1.00f, 0.59f);
		colors[ImGuiCol_ChildBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
		colors[ImGuiCol_PopupBg] = ImVec4(1.00f, 1.00f, 1.00f, 0.94f);
		colors[ImGuiCol_Border] = ImVec4(0.84f, 0.84f, 0.84f, 0.39f);
		colors[ImGuiCol_BorderShadow] = ImVec4(1.00f, 1.00f, 1.00f, 0.10f);
		colors[ImGuiCol_FrameBg] = ImVec4(1.00f, 1.00f, 1.00f, 0.94f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.68f, 0.87f, 0.68f, 0.52f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.25f, 0.68f, 0.27f, 0.54f);
		colors[ImGuiCol_TitleBg] = ImVec4(0.96f, 0.96f, 0.96f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.89f, 0.88f, 0.88f, 1.00f);
		...
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.65f, 0.84f, 0.65f, 1.00f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.15f, 0.73f, 0.11f, 1.00f);
		colors[ImGuiCol_Separator] = ImVec4(0.28f, 0.28f, 0.28f, 0.29f);
		colors[ImGuiCol_SeparatorHovered] = ImVec4(0.44f, 0.44f, 0.44f, 0.29f);
		colors[ImGuiCol_SeparatorActive] = ImVec4(0.40f, 0.44f, 0.47f, 1.00f);
		...
		colors[ImGuiCol_TabUnfocused] = ImVec4(0.00f, 0.00f, 0.00f, 0.52f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.14f, 0.14f, 0.14f, 1.00f);
		colors[ImGuiCol_DockingPreview] = ImVec4(0.19f, 0.87f, 0.25f, 0.70f);
		...
		colors[ImGuiCol_TableRowBg] = ImVec4(0.00f, 0.00f, 0.00f, 0.00f);
		colors[ImGuiCol_TableRowBgAlt] = ImVec4(1.00f, 1.00f, 1.00f, 0.06f);
		colors[ImGuiCol_TextSelectedBg] = ImVec4(0.17f, 0.84f, 0.38f, 0.35f);
		colors[ImGuiCol_DragDropTarget] = ImVec4(0.33f, 0.67f, 0.86f, 1.00f);
		colors[ImGuiCol_NavHighlight] = ImVec4(1.00f, 0.00f, 0.00f, 1.00f);
		colors[ImGuiCol_NavWindowingHighlight] = ImVec4(1.00f, 0.00f, 0.00f, 0.70f);
		colors[ImGuiCol_NavWindowingDimBg] = ImVec4(1.00f, 0.00f, 0.00f, 0.20f);
	...
	ImVec4 ST2DEditor::colorToImVec4(unsigned int hexValue)
	{
	...
	ImVec4 ST2DEditor::colorToImVec4(int r, int g, int b, int a)
	{
